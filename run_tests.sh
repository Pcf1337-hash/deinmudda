...
case $TEST_TYPE in
    "unit")
        ...
        run_test_suite "Entry Service Tests" "test/unit/entry_service_test.dart"
        run_test_suite "Substance Service Tests" "test/unit/substance_service_test.dart"
        run_test_suite "Timer Service Tests" "test/unit/timer_service_test.dart"
        ;;
        
    "integration")
        echo -e "${BLUE}Running Integration Tests Only${NC}"
        run_test_suite "Use Case Integration Tests" "test/integration/use_case_integration_test.dart"
        ;;
