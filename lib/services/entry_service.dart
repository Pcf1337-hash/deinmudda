  ...
  Future<List<Entry>> getAllEntries() async {
    try {
      ...
      return await PerformanceHelper.measureExecutionTime(() async {
        ...
        // Optimize query by limiting results in release mode on low-end devices
        final bool shouldLimit = kReleaseMode && PerformanceHelper.isLowEndDevice();
        final int limit = shouldLimit ? 100 : 0; // No limit by default
